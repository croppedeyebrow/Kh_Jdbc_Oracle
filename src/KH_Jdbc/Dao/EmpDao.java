...
// DAO : Data Access Object, 데이터베이스에 접근해 데이터를 조회하거나 수정 하기위해 사용
// [DML 과 유사한 기능]
public class EmpDao {
    ...
    public List<EmpVo> empSelect() {
        ...
        try {
            ...
            rs = stmt.executeQuery(sql); // executequqery SELECT 문에서 사용

            while (rs.next()) { // 결과에서 읽은 내용이 있으면 True (테이블 행의 개수 만큼 순회)
